...
DEFAULT_LIDAR_HEIGHT_M = 1.6
DEFAULT_STATIC_ROI_GROUND_Z_MIN_M = 0.7
DEFAULT_STATIC_ROI_GROUND_Z_MAX_M = 1.6
DEFAULT_STATIC_ROI_Z_MIN_M = DEFAULT_STATIC_ROI_GROUND_Z_MIN_M - DEFAULT_LIDAR_HEIGHT_M
DEFAULT_STATIC_ROI_Z_MAX_M = DEFAULT_STATIC_ROI_GROUND_Z_MAX_M - DEFAULT_LIDAR_HEIGHT_M
