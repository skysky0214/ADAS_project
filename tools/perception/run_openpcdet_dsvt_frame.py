...
from app.core.config import DEFAULT_DSVT_CFG_FILE, DEFAULT_DSVT_CHECKPOINT, DEFAULT_OPENPCDET_ROOT
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run OpenPCDet DSVT-Pillar on one point cloud frame")
    ...
    parser.add_argument("--cfg-file", type=Path, default=DEFAULT_DSVT_CFG_FILE)
    parser.add_argument("--checkpoint", type=Path, default=DEFAULT_DSVT_CHECKPOINT)
...
def main() -> None:
    ...
    model = OpenPCDetDSVTPerceptionModel(
